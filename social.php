...
<div class="sticky-container">
    <ul class="sticky">
        <li>
            <img src="assets/images/logo_facebook.png" width="32" height="32">
            <p><a href="https://www.facebook.com/" target="_blank">Like Us on<br>Facebook</a></p>
        </li>
        <li>
            <img src="assets/images/logo_twitter.png" width="32" height="32">
            <p><a href="https://twitter.com/" target="_blank">Follow Us on<br>Twitter</a></p>
        </li>
        <li>
            <img src="assets/images/logo_google_plus.png" width="32" height="32">
            <p><a href="https://plus.google.com/" target="_blank">Follow Us on<br>Google+</a></p>
        </li>
        <li>
            <img src="assets/images/logo_linked_in.png" width="32" height="32">
            <p><a href="https://www.linkedin.com/company/" target="_blank">Follow Us on<br>LinkedIn</a></p>
        </li>
        <li>
            <img src="assets/images/logo_you_tube.png" width="32" height="32">
